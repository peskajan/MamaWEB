...
<html>
    ...
    <body>
        ...
        <div id="content" class="main_content container">
            ...
            <h3 class="featurette-heading">Název semináře: Relaxace pro děti</h3>
            <p class="afterlead">                 
            ...
            <h3 class="featurette-heading">Název semináře: Preventivní logopedické chvilky</h3>
            <p class="afterlead">                 
            ...
            <h3 class="featurette-heading">Název semináře: Hry pro zvládání agresivity a neklidu </h3>
            <p class="afterlead">                 
            ...
            <h3 class="featurette-heading">Název semináře: Třídní klima, komunikace v ZŠ</h3>
            <p class="afterlead">                 
            ...
            <h3 class="featurette-heading">Název semináře: Cvičení pro rozvoj pozornosti</h3>
            <p class="afterlead">                 
            ...
            <h3 class="featurette-heading">Název semináře: Neklidné a nesoustředěné dítě</h3>
            <p class="afterlead">                 
            ...
            <h3 class="featurette-heading">Název semináře: Nástup dítěte do ZŠ – školní zralost</h3>
            <p class="afterlead">                 
                <b>Určeno:</b> učitelkám MŠ<br>
            ...
            <h3 class="featurette-heading">Název semináře: Rozvoj sociálních dovedností dětí předškolního věku</h3>
            <p class="afterlead">                 
                <b>Určeno:</b> učitelkám MŠ<br>
            ...
            <h3 class="featurette-heading">Název semináře: Problémové dítě v MŠ</h3>
            <p class="afterlead">                 
                <b>Určeno:</b> učitelkám MŠ<br>
            ...
            <h3 class="featurette-heading">Název semináře: Rozvoj grafomotoriky v předškolním věku</h3>
            <p class="afterlead">                 
                <b>Určeno:</b> učitelkám MŠ<br>
            ...
            <h3 class="featurette-heading">Název semináře: Efektivní komunikace s dětmi v MŠ</h3>
            <p class="afterlead">                 
                <b>Určeno:</b> učitelkám MŠ<br>
            ...
            <h3 class="featurette-heading">Název semináře: Sociální dovednosti předškolního pedagoga</h3>
            <p class="afterlead">                 
                <b>Určeno:</b> učitelkám MŠ<br>
            ...
            <h3 class="featurette-heading">Název semináře: Jak pracovat s únavou, stresem a syndromem vyhoření u učitelů</h3>
            <p class="afterlead">
