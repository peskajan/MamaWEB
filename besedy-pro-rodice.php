                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-target="#collapseOne" data-parent="#accordion">
                                <span class="label label-primary">17.9.2015</span>Změny v rodinném systému s příchodem dítěte
                            </a>
                        </h4>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-target="#collapseTwo" data-parent="#accordion" class="collapsed">
                                <span class="label label-primary">8.10.2015</span> Potřeby dítěte a jejich naplňování
                            </a>
                        </h4>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-target="#collapseThree" data-parent="#accordion" class="collapsed">
                                <span class="label label-primary">12.11.2015</span> Styly výchovy, přístup k dítěti
                            </a>
                        </h4>
