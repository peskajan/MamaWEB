                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-target="#collapseOne" data-parent="#accordion">
                                <span class="label label-primary">3.10.2015</span> Osobní síla, vnitřní zdroje
                            </a>
                        </h4>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-target="#collapseTwo" data-parent="#accordion" class="collapsed">
                                <span class="label label-primary">5.12.2015</span> Můj střed a rovnováha
                            </a>
                        </h4>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <table class="afterlead">
                        ...
                        <tr><td class="bold">Cena</td><td>550 Kč <a id="a-price-detail" href="" title="Podrobněji o ceně">(*)</a></td></tr>
                    </table>
