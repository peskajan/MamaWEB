...
<html>
    <head>
        ...
        <title>Sebezkušenostní seminář | Katka Pešková | Psychoterapeut | Speciální pedadog | Slaný a okolí</title>
    ...
    <body>
        ...
        <div id="content" class="main_content container">
            ...
            <h2 class="page-heading">Sebezkušenostní seminář</h2>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <table class="afterlead">
                        ...
                        <tr><td class="bold">Cena</td><td>650 Kč <a id="a-price-detail" href="" title="Podrobněji o ceně">(*)</a></td></tr>
                    </table>
                    <a class="btn btn-contactme btn-primary" href="/kontakty/">Máte zájem? Kontaktujte mě!</a>
                </div>
                <div class="col-lg-6">
                    <img class="example-image-link parallelogram" src="/images/gallery/sebezkusenostni.jpg" alt="Sebezkušenostní seminář, skupinová terapie, pro ženy, arteterapie"/>
                </div>
            </div>
