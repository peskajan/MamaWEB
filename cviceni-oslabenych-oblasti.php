...
<html>
    ...
    <body>
        ...
        <div id="content" class="main_content container">
            ...
            <ul class="afterlead">
                <li>cvičení pro rozvoj pozornosti u předškolních dětí</li>
                <li>cvičení pro rozvoj pozornosti KUPOZ pro 8-12 let</li>
                <li>cvičení pro rozvoj jemné motoriky pro 3-4 leté děti</li>
                <li>cvičení pro rozvoj grafomotoriky u předškolních dětí</li>
            </ul>
                ...
                <div class="col-lg-7">
                    <table class="afterlead">
                        ...
                        <tr><td>Cvičení pro rozvoj pozornosti u předškolních dětí</td> 
                            <td class="price">1 300 Kč</td></tr>
                        <tr><td>Cvičení pro rozvoj pozornosti KUPOZ pro 8-12 let</td> 
                            <td class="price">2 000 Kč</td></tr>
                        <tr><td>Cvičení pro rozvoj grafomotoriky</td> 
                            <td class="price">1 300 Kč</td></tr>
                        <tr><td>Cvičení pro rozvoj jemné motoriky</td> 
                            <td class="price">1 300 Kč</td></tr>
                    </table>
